...
import {createDonor, Donor} from "../../../api/donor.tsx";
...
export default function DonorRegForm() {
        ...
        const handleSubmit = async () => {
                const donorData: Donor = {
                        ...
                        numberOfTimesDonated: 0, // Replace with a valid number
                        lastDonationDate: '', // Replace with a valid date string
                        willingToDonateFrequency: formData.donateRegularly,
                        longTermIllness: formData.longTermIllness === 'Yes',
                        takingMedicine: formData.takingMedicine === 'Yes',
                        undergoneSurgery: formData.hadSurgery === 'Yes',
                };
