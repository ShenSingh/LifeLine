...
const navigation = [
    ...
    {name: 'Find Donor', href: '/findDonor', current: false},
    {name: 'About Us', href: 'aboutUs', current: false},
    {name: 'Donor', href: 'donor', current: false},
];
...
export default function Navbar({}: NavbarProps) {
    ...
    return (
        <Disclosure as="nav"
                    className={`bg-gray-800 ${isNavbarVisible ? 'block' : 'hidden'} transition-all fixed top-0 w-full z-50`}>
            <TopBanner/>
